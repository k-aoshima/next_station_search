...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _getDistance() async {
    ...
    for (int i = 0; i < _lineInfo.lineNo.length; i++) {
      distance = await distanceInMeters(double.parse(_lineInfo.latitude[i]),
    ...
    while (!seachCompleate) {
      for (var item in dic.keys) {
        ...
        if (dic[item] == distance) {
          ...
          if ((distance >= 30.0) &&
              (ret > 0 && ret < _lineInfo.stationName.length)) {
            // 現在駅から近い駅を二つ取得
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(40, 0, 10, 0),
                child: Stack(
                  ...
                  children: [
                    ...
                    Text(_routeInfo.abbreviation[_selectedRoute],
                        style: TextStyle(
                            ...
                            color: _routeInfo.routeColor[_selectedRoute])),
                  ],
                )),
            Text(
                ...
                children: [
                    ...
                    children: [
                      CustomPaint(
                          painter: TrianglePainter(
                              _routeInfo.routeColor[_selectedRoute]),
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0, 0, 0, 55),
                        child: Text(
                            _setStationName.isNotEmpty
                                ? _setStationName[0]
                                : _lineInfo.stationName[0],
                            style: const TextStyle(
                                fontFamily: "BIZUDPGothic", fontSize: 28)),
                      ),
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0, 0, 0, 55),
                      ...
                      Padding(
                        ...
                        child: Text(_routeInfo.routeName[_selectedRoute],
                            style: const TextStyle(
                                fontFamily: "BIZUDPGothic", fontSize: 15)),
                      ),
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0, 0, 0, 55),
        ...
        child: Drawer(
          child: ListView(
            ...
            children: [
              DrawerHeader(
                decoration:
                    BoxDecoration(color: _routeInfo.routeColor[_selectedRoute]),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0, 0, 70, 10),
                        child: Stack(
                          alignment: const Alignment(0, 0),
                          children: [
                            Container(
              ...
              ListTile(
                  ...
                  title: const Text('路線設定',
                      style: TextStyle(fontFamily: "BIZUDPGothic")),
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                              RouteSettingScreen(_routeInfo, _selectedRoute)),
                    ).then((value) =>
                        {setSelectedRoute(value), _getFutureData(value)});
                  }),
              ListTile(
                  trailing: const Icon(
                    Icons.arrow_forward_ios,
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ReadIntervalSettingScreen(_routeInfo, _loopSec)),
                    ).then((value) => {
                          setState(() {
                            ...
                            _timer = Timer.periodic(
                                Duration(seconds: _loopSec), _onTimer);
                          })
                        });
                  }),
            ],
